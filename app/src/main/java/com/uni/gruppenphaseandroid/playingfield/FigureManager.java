...
public class FigureManager {
    ...
    private int createRightDrawable(Color color, Typ typ) {
        ...
        if (color == Color.BLUE) {
            switch (typ) {
                case JERK:
                    return R.drawable.ic_bluejester;
                case CITIZEN:
                    return R.drawable.ic_bluecitizen;
                case KNIGHT:
                    return R.drawable.ic_blueknight;
                case KING:
                    return R.drawable.ic_blueking;
            }
        } else if (color == Color.GREEN) {
            switch (typ) {
                case JERK:
                    return R.drawable.ic_greenjester;
                case CITIZEN:
                    return R.drawable.ic_greencitizen;
                case KNIGHT:
                    return R.drawable.ic_greenknight;
                case KING:
                    return R.drawable.ic_greenking;
            }
        } else if (color == Color.RED) {
            switch (typ) {
                case JERK:
                    return R.drawable.ic_redjester;
                case CITIZEN:
                    return R.drawable.ic_redcitizen;
                case KNIGHT:
                    return R.drawable.ic_redknight;
                case KING:
                    return R.drawable.ic_redking;
            }
        } else {
            switch (typ) {
                case JERK:
                    return R.drawable.ic_yellowjester;
                case CITIZEN:
                    return R.drawable.ic_yellowcitizen;
                case KNIGHT:
                    return R.drawable.ic_yellowknight;
                case KING:
                    return R.drawable.ic_yellowking;
            }
        }
        return 0;
    }
